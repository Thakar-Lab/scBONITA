...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Separator for the conditions file. Must be one of , (comma), \s (space) or \t (tab).",
        type=str,
        choices=[",", "\s", "\t"],
        required=True,
    )
    ...
    parser.add_argument(
        "--contrast_separator",
        help="Separator for the contrast file. Must be one of , (comma), \s (space) or \t (tab).",
        type=str,
        choices=[",", "\s", "\t"],
        required=True,
    )
    ...
    print(dataFile)
    scTest = pickle.load(open(dataFile + "scTest.pickle", "rb"))
    scTest.run_pathway_analysis_from_outs(
        contrast=results.contrast,
        conditions=results.conditions,
